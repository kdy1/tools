...
package main // import "github.com/kdy1/tools/cmd/callgraph"
...
import (
	...
	"github.com/kdy1/tools/go/callgraph/rta"
	"github.com/kdy1/tools/go/callgraph/static"
	"github.com/kdy1/tools/go/packages"
	"github.com/kdy1/tools/go/pointer"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/kdy1/tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/kdy1/tools/cmd/callgraph |
      digraph succs github.com/kdy1/tools/cmd/callgraph.main
`
