...
import (
	...
	"github.com/kdy1/tools/internal/lsp/foo" //@link(`github.com/kdy1/tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/kdy1/tools/internal/lsp/foo?utm_source=gopls`)
