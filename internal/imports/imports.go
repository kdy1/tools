...
// Options is github.com/kdy1/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/kdy1/tools/imports.Process with explicit context in opt.Env.
