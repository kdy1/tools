...
import (
	...
	"github.com/kdy1/tools/internal/lsp/command/commandmeta"
...
func rewriteAPI(_ []byte, api *source.APIJSON) ([]byte, error) {
	...
	fmt.Fprintf(&buf, "// Code generated by \"github.com/kdy1/tools/gopls/doc/generate\"; DO NOT EDIT.\n\npackage source\n\nvar GeneratedAPIJSON = ")
	if err := printsrc.NewPrinter("github.com/kdy1/tools/internal/lsp/source").Fprint(&buf, api); err != nil {
		return nil, err
	}
